<template>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active" onclick="window.location.href='project.html'" style="cursor:pointer;">
        <img src="~@/assets/img/carousel-1.jpg" alt="First slide">
      </div>
      <div class="item" onclick="window.location.href='project.html'" style="cursor:pointer;">
        <img src="~@/assets/img/carousel-2.jpg" alt="Second slide">
      </div>
      <div class="item" onclick="window.location.href='project.html'" style="cursor:pointer;">
        <img src="~@/assets/img/carousel-3.jpg" alt="Third slide">
      </div>
    </div>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img class="img-circle" src="~@/assets/img/p1.jpg" alt="Generic placeholder image"
      ...
      <div class="col-lg-4">
        <img class="img-circle" src="~@/assets/img/p2.jpg" alt="Generic placeholder image"
             style="width: 140px; height: 140px;">
        <h2>NEOKA智能手环</h2>
      ...
      <div class="col-lg-4">
        <img class="img-circle" src="~@/assets/img/p3.png" alt="Generic placeholder image"
             style="width: 140px; height: 140px;">
        <h2>驱蚊扣</h2>
          ...
          <div class="box ui-draggable" id="mainBox">
            ...
            <div class="mBd" style="padding-top:10px;">
              <div class="row">
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-1.jpg"/>
                    <div class="caption">
                      <h3 class="break">
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-2.gif"/>
                    <div class="caption">
                      <h3 class="break">
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-3.png"/>
                    <div class="caption">
                      <h3 class="break">
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-4.jpg"/>
                    <div class="caption">
                      <h3 class="break">
          ...
          <div class="box ui-draggable" id="mainBox">
            ...
            <div class="mBd" style="padding-top:10px;">
              <div class="row">
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-5.jpg"/>
                    <div class="caption">
                      <h3 class="break">
                        <a href="project.html">活性富氢净水直饮机</a>
                      </h3>
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-6.jpg"/>
                    <div class="caption">
                      <h3 class="break">
                        <a href="project.html">酷驰触控龙头，智享厨房黑科技</a>
                      </h3>
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-7.jpg"/>
                    <div class="caption">
                      <h3 class="break">
                        <a href="project.html">小熊猫鱼眼全景安防摄像机</a>
                      </h3>
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-8.jpg"/>
                    <div class="caption">
                      <h3 class="break">
                        <a href="project.html">一款精致的机械表</a>
                      </h3>
          ...
          <div class="box ui-draggable" id="mainBox">
            ...
            <div class="mBd" style="padding-top:10px;">
              <div class="row">
                <div class="col-md-3">
                  <div class="thumbnail">
                    <img alt="300x200" src="~@/assets/img/product-9.jpg"/>
                    <div class="caption">
                      <h3 class="break">
                        <a href="project.html">活性富氢净水直饮机</a>
                      </h3>
