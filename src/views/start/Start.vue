          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height:400px;overflow-y:auto;padding:10px;">
              <div class="test-box">
                ...
                <p>9.3筹款成功后尚筹网众筹平台将在<b>3</b>个工作日内将募集总金额扣除平台服务费以及质量保证金（如有）后剩余款项的<b>60%</b>交付给发起人，并预留余下的<b>40%</b>作为确保项目成功并保证支持者获得回报的保证金(以下简称“保证金”)。在项目成功、无纠纷且所有支持者得到承诺回报的情况下，尚筹网将把这部分款项交付给发起人。发起人与尚筹网另有约定的除外。
                </p>
                <p>
            ...
            <div class="panel-footer" style="text-align:center;">
              <button type="button" class="btn  btn-warning btn-lg" @click="nextStep">阅读并同意协议</button>
            </div>
          </div>
        </div>
      </div>
