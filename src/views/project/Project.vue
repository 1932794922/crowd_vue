          ...
          <div class="jumbotron nofollow" style="    padding-top: 10px;">
            ...
            <div style="float:right;">
              <button type="button" class="btn btn-default"><i style="color:#f60"
                                                               class="glyphicon glyphicon-heart"></i> 关注 111
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12 column">
          <div class="row clearfix">
            <div class="col-md-8 column">
              <img alt="140x140" width="740" src="~@/assets/img/product_detail_head.jpg"/>
              <img alt="140x140" width="740" src="~@/assets/img/product_detail_body.jpg"/>
            ...
            <div class="col-md-4 column">
              ...
              <div class="prjtip panel panel-default" style="border-radius: 0px;">
                <div class="panel-body">
                  <img src="~@/assets/img/product-3.png" width="100%" height="100%">
                </div>
              </div>

              <div class="prjtip panel panel-default" style="border-radius: 0px;">
                <div class="panel-body">
                  <img src="~@/assets/img/product-4.jpg" width="100%" height="100%">
                </div>
              </div>
            </div>
          </div>
